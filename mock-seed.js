...
export function seed() {
  ...
  const publicTags = {};
  for (const [id, m] of Object.entries(machines)) publicTags[m.assetTag] = { machineId: id, name: m.name };
  return { venues, machines, takings, repayments, tickets, faultQueue, nayaxDevices, publicTags, nayaxImports: {}, costs: {}, settings: { app: { migratedFinance: true } } };
}
